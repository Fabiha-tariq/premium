...
<head>
    ...
    <!-- SummerNote Css -->
    <link rel="stylesheet" href="{{ asset('public/assets/css/summernote-lite.min.css') }}"/>
...
<body>
    ...
    <!-- Dragula js -->
    <script src="{{ asset('public/assets/js/dragula.min.js') }}"></script>
    <script src="{{ asset('public/assets/js/onDomChange.js') }}"></script>
    <script src="{{ asset('public/assets/js/Sortable.min.js') }}"></script>
    <script src="{{ asset('public/assets/js/jquery-sortable.js') }}"></script>
    <!-- SummerNote Js -->
    <script src="{{ asset('public/assets/js/summernote-lite.min.js') }}"></script>
